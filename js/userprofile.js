...
function favorite() {
  ...
  document.querySelector(".container-section2").style.width = "80%";
  displayFav();
}
...
function details() {
  ...
  document.querySelector(".container-section2").style.width = "60%";
}
